...
- Complexity scorer, tier catalog and auto-routing config (auto router 1/8) ([#217](https://github.com/UmaiTech/aura-llm-gateway/pull/217))
- Resolve model "auto" through the complexity router (auto router 2/8) ([#218](https://github.com/UmaiTech/aura-llm-gateway/pull/218))
- Routing_decisions table, outcomes view and admin auto-router stats (auto router 3/8) ([#219](https://github.com/UmaiTech/aura-llm-gateway/pull/219))
- Model catalog, per-org overrides and GET /v1/models (auto router 4/8) ([#220](https://github.com/UmaiTech/aura-llm-gateway/pull/220))
- Outcome signals from the conversation graph and Thompson within-tier selection (auto router 5/8) ([#221](https://github.com/UmaiTech/aura-llm-gateway/pull/221))
- LLM classifier, gold-label collection and traffic replay (auto router 6/8) ([#222](https://github.com/UmaiTech/aura-llm-gateway/pull/222))
- Learned classifier with offline training and model registry (auto router 7/8) ([#223](https://github.com/UmaiTech/aura-llm-gateway/pull/223))
- Escalation after provider failures and a per-model circuit breaker (auto router 8/8) ([#224](https://github.com/UmaiTech/aura-llm-gateway/pull/224))
- Auto router 9/9 – learned cost model, predicted-cost ranking and per-request budgets ([#225](https://github.com/UmaiTech/aura-llm-gateway/pull/225))
...
- September 2026 model catalog refresh ([#227](https://github.com/UmaiTech/aura-llm-gateway/pull/227))
...
- Derive the SDK publish version from the release tag in the Python (PyPI) and TypeScript (npm) workflows, so the SDKs always ship at the release version regardless of the best-effort "Sync SDK versions" PR step (v0.16.0 shipped with stale SDK manifests and could not publish)

<!-- regenerated by hand: release-plz could not tag v0.16.1 (manual tag) and
     this changelog/SDK-publish fix is frontend/CI-only, so it isn't attributed
     to a Rust crate by the per-crate filter. -->

## [0.16.0] - 2026-06-30

### Features

- Fireworks AI provider + KnownModels SDK catalog ([#209](https://github.com/UmaiTech/aura-llm-gateway/pull/209)) ([#212](https://github.com/UmaiTech/aura-llm-gateway/pull/212))
