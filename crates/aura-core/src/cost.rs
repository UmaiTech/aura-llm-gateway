...
impl CostCalculator {
    ...
    pub fn new() -> Self {
        ...
        // =================================================================
        // OpenAI pricing (as of August 2026)
        // =================================================================

        // GPT-5.6 family (2026) — short-context standard tier; long-context
        // and batch/flex tiers exist and are ~2x / 0.5x these rates.
        pricing.insert(
        ...
        // =================================================================
        // Anthropic pricing (as of August 2026)
        // =================================================================

        // Claude Opus 5 (2026-07-24) + Opus 4.8 (2026-05-28) — same rate card
        pricing.insert(
        ...
        pricing.insert(
            "claude-opus-4-8-20260528".to_string(),
            ModelPricing::new(5.00, 25.00).with_cached(0.50),
        );

        // Claude Fable 5 (2026-06-09) — new top tier, 2x Opus 4.8
        pricing.insert(
            "claude-fable-5".to_string(),
            ModelPricing::new(10.00, 50.00).with_cached(1.00),
        );

        // Claude Sonnet 5 (2026-06-30) — intro pricing $2/$10 through
        // 2026-08-31, then $3/$15 (standard, same as Sonnet 4.6).
        pricing.insert(
