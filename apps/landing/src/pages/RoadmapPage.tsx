...
const releases: Release[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Auto-updating pricing scraper', note: 'Weekly job scrapes each provider’s own pricing page (all 8 providers, incl. Together) into versioned price history.' },
      { label: 'Public pricing page', note: 'aura-llm.dev/pricing — live scraped prices across every provider.' },
      { label: 'Docs & playground read live prices', note: 'ModelTable and the chat cost calculator now pull from the pricing DB instead of hardcoded tables.' },
    ],
    issueRefs: ['#123'],
  },
  {
