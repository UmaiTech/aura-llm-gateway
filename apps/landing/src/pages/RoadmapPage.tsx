...
const releases: Release[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Live gateway settings in the admin app', note: 'The Settings page now edits real configuration: switch auto routing on, change its mode, classifier and tier lists, and flip payload capture, tool-context replay, caching and rate-limit defaults without a redeploy. Values persist in Postgres and apply immediately; environment-only settings are shown read-only.' },
