...
const releases: Release[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'September 2026 model catalog refresh', note: 'GPT-6 Astra and the GPT-5.6 Sol / Terra / Luna tiers, Claude Fable 5.1, Opus 5, Sonnet 5 and Opus 4.8, and Gemini 3.7 Flash, 3.6 Flash and 3.5 Flash-Lite — routable through the gateway with seed pricing, SDK constants and playground entries.' },
    ],
    issueRefs: ['#123', '#209'],
  },
  {
